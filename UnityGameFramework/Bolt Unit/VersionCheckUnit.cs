...
namespace Icarus.UnityGameFramework.Bolt
{
    ...
    public class VersionCheckUnit:Unit
    {
        [PortLabel("arg")]
        [Serialize]
        private ValueInput _argIn;

        [PortLabel("app更新地址")]
        [Serialize]
        private ValueInput _appUpdateUrlIn;

        [PortLabel("严格模式")]
        [Serialize]
        private ValueInput _strictMode; 
        ...
        [PortLabel("失败信息")]
        private ValueOutput _errorMessageOut;

        [PortLabel("result")]
        private ValueOutput _resultOut;
