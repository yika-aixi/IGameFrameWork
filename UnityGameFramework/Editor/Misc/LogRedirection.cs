...
namespace Icarus.UnityGameFramework.Editor
{
    ...
    internal static class LogRedirection
    {
        ...
        private static bool OnOpenAsset(int instanceId, int line)
        {
            ...
            InternalEditorUtility.OpenFileAtLineExternal(Icarus.GameFramework.Utility.Path.GetCombinePath(Application.dataPath, match.Groups[1].Value.Substring(7)), int.Parse(match.Groups[2].Value));
            return true;
        }
