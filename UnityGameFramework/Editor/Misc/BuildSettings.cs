...
namespace Icarus.UnityGameFramework.Editor
{
    ...
    internal static class BuildSettings
    {
        ...
        {
            s_ConfigurationPath = Type.GetConfigurationPath<BuildSettingsConfigPathAttribute>() ?? Icarus.GameFramework.Utility.Path.GetCombinePath(Application.dataPath, "GameFramework/Configs/BuildSettings.xml");
