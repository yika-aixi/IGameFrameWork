...
using Icarus.GameFramework.Entity;
...
namespace Icarus.UnityGameFramework.Runtime
{
    ...
    public sealed partial class EntityComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_EntityHelperTypeName = "Icarus.UnityGameFramework.Runtime.DefaultEntityHelper";

        [SerializeField]
        private EntityHelperBase m_CustomEntityHelper = null;

        [SerializeField]
        private string m_EntityGroupHelperTypeName = "Icarus.UnityGameFramework.Runtime.DefaultEntityGroupHelper";
        ...
        private void OnShowEntitySuccess(object sender, Icarus.GameFramework.Entity.ShowEntitySuccessEventArgs e)
        {
        ...
        private void OnShowEntityFailure(object sender, Icarus.GameFramework.Entity.ShowEntityFailureEventArgs e)
        {
        ...
        private void OnShowEntityUpdate(object sender, Icarus.GameFramework.Entity.ShowEntityUpdateEventArgs e)
        {
        ...
        private void OnShowEntityDependencyAsset(object sender, Icarus.GameFramework.Entity.ShowEntityDependencyAssetEventArgs e)
        {
        ...
        private void OnHideEntityComplete(object sender, Icarus.GameFramework.Entity.HideEntityCompleteEventArgs e)
        {
