        ...
        public static partial class Zip
        {
            ...
            public static byte[] Compress(byte[] bytes)
            {
                ...
                catch (Exception exception)
                {
                    ...
                    throw new GameFrameworkException(string.Format("Can not compress bytes with exception '{0}'.", exception.ToString()), exception);
                }
            }
            ...
            public static byte[] Decompress(byte[] bytes)
            {
                ...
                catch (Exception exception)
                {
                    ...
                    throw new GameFrameworkException(string.Format("Can not decompress bytes with exception '{0}'.", exception.ToString()), exception);
                }
            }
        }
    }
