            ...
            private sealed class ResourceObject : ObjectBase
            {
                ...
                protected internal override void Release(bool isShutdown)
                {
                    if (!isShutdown)
                    {
                        ...
                        {
                            throw new GameFrameworkException(string.Format("Resource target '{0}' reference count is '{1}' larger than 0.", Name, targetReferenceCount.ToString()));
                        }
                        ...
                        foreach (object dependencyResource in m_DependencyResources)
                        {
                            ...
                            {
                                throw new GameFrameworkException(string.Format("Resource target '{0}' dependency asset reference count is invalid.", Name));
                            }
                        }
                    }
