        ...
        private partial class ResourceLoader
        {
            ...
            private sealed partial class LoadResourceAgent : ITaskAgent<LoadResourceTaskBase>
            {
                ...
                private void OnDependencyAssetReady()
                {
                    ...
                    string fullPath = Icarus.GameFramework.Utility.Path.GetCombinePath(m_Task.ResourceInfo.StorageInReadOnly ? m_ReadOnlyPath : m_ReadWritePath, Icarus.GameFramework.Utility.Path.GetResourceNameWithSuffix(m_Task.ResourceInfo.ResourceName.FullName));
