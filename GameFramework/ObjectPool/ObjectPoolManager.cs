...
namespace Icarus.GameFramework.ObjectPool
{
    ...
    internal sealed partial class ObjectPoolManager : GameFrameworkModule, IObjectPoolManager
    {
        ...
        {
            return InternalHasObjectPool(Icarus.GameFramework.Utility.Text.GetFullName<T>(string.Empty));
        }
        ...
        public bool HasObjectPool(Type objectType)
        {
            ...
            return InternalHasObjectPool(Icarus.GameFramework.Utility.Text.GetFullName(objectType, string.Empty));
        }
        ...
        {
            return InternalHasObjectPool(Icarus.GameFramework.Utility.Text.GetFullName<T>(name));
        }
        ...
        public bool HasObjectPool(Type objectType, string name)
        {
            ...
            return InternalHasObjectPool(Icarus.GameFramework.Utility.Text.GetFullName(objectType, name));
        }
        ...
        {
            return (IObjectPool<T>)InternelGetObjectPool(Icarus.GameFramework.Utility.Text.GetFullName<T>(string.Empty));
        }
        ...
        public ObjectPoolBase GetObjectPool(Type objectType)
        {
            ...
            return InternelGetObjectPool(Icarus.GameFramework.Utility.Text.GetFullName(objectType, string.Empty));
        }
        ...
        {
            return (IObjectPool<T>)InternelGetObjectPool(Icarus.GameFramework.Utility.Text.GetFullName<T>(name));
        }
        ...
        public ObjectPoolBase GetObjectPool(Type objectType, string name)
        {
            ...
            return InternelGetObjectPool(Icarus.GameFramework.Utility.Text.GetFullName(objectType, name));
        }
        ...
        {
            return InternalDestroyObjectPool(Icarus.GameFramework.Utility.Text.GetFullName<T>(string.Empty));
        }
        ...
        public bool DestroyObjectPool(Type objectType)
        {
            ...
            return InternalDestroyObjectPool(Icarus.GameFramework.Utility.Text.GetFullName(objectType, string.Empty));
        }
        ...
        {
            return InternalDestroyObjectPool(Icarus.GameFramework.Utility.Text.GetFullName<T>(name));
        }
        ...
        public bool DestroyObjectPool(Type objectType, string name)
        {
            ...
            return InternalDestroyObjectPool(Icarus.GameFramework.Utility.Text.GetFullName(objectType, name));
        }
        ...
        public bool DestroyObjectPool<T>(IObjectPool<T> objectPool) where T : ObjectBase
        {
            ...
            return InternalDestroyObjectPool(Icarus.GameFramework.Utility.Text.GetFullName<T>(objectPool.Name));
        }
        ...
        public bool DestroyObjectPool(ObjectPoolBase objectPool)
        {
            ...
            return InternalDestroyObjectPool(Icarus.GameFramework.Utility.Text.GetFullName(objectPool.ObjectType, objectPool.Name));
        }
        ...
        private IObjectPool<T> InternalCreateObjectPool<T>(string name, bool allowMultiSpawn, int capacity, float expireTime, int priority) where T : ObjectBase
        {
            ...
            {
                throw new GameFrameworkException(string.Format("Already exist object pool '{0}'.", Icarus.GameFramework.Utility.Text.GetFullName<T>(name)));
            }

            ObjectPool<T> objectPool = new ObjectPool<T>(name, allowMultiSpawn, capacity, expireTime, priority);
            m_ObjectPools.Add(Icarus.GameFramework.Utility.Text.GetFullName<T>(name), objectPool);
            return objectPool;
        }
        ...
        private ObjectPoolBase InternalCreateObjectPool(Type objectType, string name, bool allowMultiSpawn, int capacity, float expireTime, int priority)
        {
            ...
            {
                throw new GameFrameworkException(string.Format("Already exist object pool '{0}'.", Icarus.GameFramework.Utility.Text.GetFullName(objectType, name)));
            }
            ...
            m_ObjectPools.Add(Icarus.GameFramework.Utility.Text.GetFullName(objectType, name), objectPool);
            return objectPool;
        }
